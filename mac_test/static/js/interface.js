...
switch(test)
{
	case "1" : if ((document.info.T1.value=='+') || (document.info.T1.value=='-') || (document.info.T1.value=='x') || (document.info.T1.value==':')|| (document.info.T1.value=='='))
			   document.info.T1.value='';
			   document.info.T1.value=document.info.T1.value+x;
			   document.info.operande1.value=document.info.operande1.value+x;
			   document.info.operande1.focus();
			   break;
	case "2" : if ((document.info.T1.value=='+') || (document.info.T1.value=='-') || (document.info.T1.value=='x') || (document.info.T1.value==':')|| (document.info.T1.value=='='))
			   document.info.T1.value='';
			   document.info.T1.value=document.info.T1.value+x;
			   document.info.operande2.value=document.info.operande2.value+x;
			   document.info.operande2.focus();
			   break;
	case "3" : if ((document.info.T1.value=='+') || (document.info.T1.value=='-') || (document.info.T1.value=='x') || (document.info.T1.value==':')|| (document.info.T1.value=='='))
			   document.info.T1.value='';
			   document.info.T1.value=document.info.T1.value+x;
			   document.info.operande3.value=document.info.operande3.value+x;
			   document.info.operande3.focus();
			   break;
	case "4" : if ((document.info.T1.value=='+') || (document.info.T1.value=='-') || (document.info.T1.value=='x') || (document.info.T1.value==':')|| (document.info.T1.value=='='))
			   document.info.T1.value='';
			   document.info.T1.value=document.info.T1.value+x;
			   document.info.resultat1.value=document.info.resultat1.value+x;
			   document.info.resultat1.focus();
			   break;
	case "5" : if ((document.info.T1.value=='+') || (document.info.T1.value=='-') || (document.info.T1.value=='x') || (document.info.T1.value==':')|| (document.info.T1.value=='='))
			   document.info.T1.value='';
			   document.info.T1.value=document.info.T1.value+x;
