...
function verifForm()
{
    //alert('op1='+document.info.operande1.value+' \nop2=' + document.info.operande2.value+' \nop3='+document.info.operande3.value+' \nres='+document.info.resultat1.value);
...
{ 
	...
	document.info.operateur2.selectedIndex=0;	
if (document.info.R1[0].checked)
	...
	document.forms['info'].operateur1.options[3]= new Option("x"," x ");
	document.forms['info'].operateur1.options[4]= new Option(":"," : ");
	}
	...
	document.forms['info'].operateur1.options[3] = null;
	document.forms['info'].operateur1.options[3] = null;
	}	
	document.info.operande1.value=''; 
	document.info.operande2.value=''; 
	document.info.operande3.value='';
	...
	switch(val)
	{
		case "+" : document.info.operateur1.selectedIndex=1;
				   if (document.info.R1[1].checked)
					{
						document.info.operateur2.selectedIndex=1;
						if (tester != 5) document.info.operande1.focus();
					}
		...
		case "-" : document.info.operateur1.selectedIndex=2;
				   if (document.info.R1[1].checked)
				   {
					   document.info.operateur2.selectedIndex=2;
					   if (tester != 5) document.info.operande1.focus();
					}
					else 
					{
		...
		case "x" : document.info.operateur1.selectedIndex=3;
				   if(tester=='1' || tester=='2' || tester=='3' || tester=='4')
				   		{
							document.info.operande2.value='';
...
{	
	switch(tester)
	{
		...
		case "3" : document.info.operande3.value=document.info.operande3.value+x;
				   document.info.operande3.focus(); colorFocus('op3');
				   break;
...
if (document.info.R1[0].checked)
...
else if (document.info.R1[1].checked)
	{
		...
		{
			var x =0;
			switch(document.info.operateur2.options[document.info.operateur2.selectedIndex].value)
			    {
					case " + " : switch(document.info.operateur1.options[document.info.operateur1.selectedIndex].value)
								{
								 case " + " : conc = document.info.operande3.value.replace(',','.') + "+" + 
								 					 document.info.operande1.value.replace(',','.') + "+" + 
													 document.info.operande2.value.replace(',','.');
											  x = eval(conc);
											  x = x.toString();
											  window.document.info.resultat1.value = x.replace('.',',');
											  break;
								 case " - " : conc = document.info.operande3.value.replace(',','.') + "+" + 
											  ...
											  if (x<0) 
											  {
												  alert("je ne peux pas faire cette opération");
											  }
											  else 
											  {
											  	  x = x.toString();
...
function verifCal()
{
		if(((document.info.operande1.value=='')||(document.info.operande2.value=='')||(document.info.operateur1.options[document.info.operateur1.selectedIndex].value=='   ')||(document.info.resultat1.value==''))&&(document.info.R1[0].checked))
			{
				alert("Ton opération n'est pas complète");
				document.info.operande1.focus();
			}
	    else if(((document.info.operande1.value=='')||(document.info.operande2.value=='')||(document.info.operande3.value=='')||(document.info.operateur1.options[document.info.operateur1.selectedIndex].value
=='   ')||(document.info.operateur2.options[document.info.operateur2.selectedIndex].value
=='   ')||(document.info.resultat1.value==''))&&(document.info.R1[1].checked))
			{
				alert("Ton opération n'est pas complète");
				document.info.operande3.focus();
			}
...
function afficheCal()
{
	...
	opp = document.info.operateur2.options[document.info.operateur2.selectedIndex].value+"\n";
	if (document.info.R1[0].checked)
		{
		if (n1 < n2)
			{
		...
		if (n1 < n2)
		{
			if (n2 < n4)
				{
					n5=n4-n1; n6=n4-n2;
					for(i=0 ; i< n5 ;i++) op1=" "+op1;
					for(i=0 ; i< n6 ;i++) op2=" "+op2;
				}
				else if (n1 < n4)
					{
						n5=n2-n1; n6=n2-n4;
						for(i=0 ; i< n5 ;i++) op1=" "+op1;
						for(i=0 ; i< n6 ;i++) op4=" "+op4;
					}
					else 
						{
							n5=n2-n1; n6=n2-n4;
	...
	else 
		 {
				if (n1 < n4)
				{
					...
					for(i=0 ; i< n6 ;i++) op2=" "+op2;
					 ...
					 {
						n5=n1-n4; n6=n1-n2;
						for(i=0 ; i< n5 ;i++) op4=" "+op4;
						for(i=0 ; i< n6 ;i++) op2=" "+op2;
					 }
					 else 
						  {
							n5=n1-n2; n6=n1-n4;
							for(i=0 ; i< n5 ;i++) op2=" "+op2;
							for(i=0 ; i< n6 ;i++) op4=" "+op4;
						  }
		}
