  ...
  <tr>
	...
	<table border="0" cellspacing="2">
        <tr>
		  ...
		  <span style="color:#0000CC"><b>&nbsp;&nbsp; Exercice N° 
		  <?php echo ($_SESSION["totalExo"]-$nbExo+1); ?> &nbsp;&nbsp;</b></span>
...
if ($questi=="1")
        ...
        <tr>
          <td height="36" colspan="2" align="center"><b>Pour &eacute;crire, tu peux cliquer sur les mots de l'&eacute;nonc&eacute;</b></td>
        </tr>
        <tr>
          ...
          <td align="center"><input type="button" value="Effacer tout" name="efface5" style="font-size: 9pt" onClick="document.info.T1.value='';document.info.T1.focus();"></td>
        </tr>   
		 <tr>
		   <td height="43" colspan="2" align="center">
		   <input name="button2" type="button" style="color:#000066"  onClick="inserer(document.info.T1.value);" value="     Ecrire dans la feuille     ">
		   </td>
        </tr>
		<tr>
          <td height="30" colspan="2" align="center"><b>Tu peux t'aider de la calculette</b>
        </tr>
        <tr>
...
<table width="796"  border="0" align="center">
  <tr>
    <td align="center"><a href="javascript:;" onClick="abandonner();">Quitter</a></td>
  </tr>
  <tr>
    <td align="right">
