...
if((isset($_GET['delete']))){
	$ex=$_GET['num'];
	$dossier2 = "audio/distributivite/exo$ex/";//prendre les caracteristiques de l'enoncé 
		if (is_dir($dossier2)){
...
<?php
    ...
    header('Refresh: 2; url=audio_distributivite.php'); 
    ob_flush();	  
    } 
...
<!--
document.location.replace("audio_distributivite.php");
// -->
</script>';
...
<form method="POST" action="audio_distributivite_upload.php" enctype="multipart/form-data">
