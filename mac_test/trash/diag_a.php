...
echo "le dernier tableaux d'operande est :<br>"; print_r($dernierTabOp);echo "<br><br>";
if (isset($tabImp) and $dernierTabOp["1"]==end($tabImp))
{
	$addTrou=true;
}
...
if (isset($tabImp))
{
	...
	{
		if ((count($tabOperation)==1)and(count($tabImp)==2))
		{
			//$nombre=$nombre_bis;
			...
			{
			$colonne2=2;$colonne3=0;$colonne6=0;$colonne7=9;$colonne8=0;$colonne14=0; $colonne15=0; $colonne16=9; $colonne17=0;
...
for ($k = 0 ; $k < count($tabOperation); $k++)
{
	...
	$etape1=false; $etape2=false;  $difference=false;
	...
	if ((!$etape1 || !difference)and(!$verrou2))
	{
		   ...
		   if ((($question=="t")and(($op1.$op.$op2."=".$res) == ($valdiff."+".$op2."=".$partie1)))||
			  (($question=="p")and(($op1.$op.$op2."=".$res) == ($valdiff."+".$op2."=".$tout1))))
					 ...
					 (($question=="p")and(($op1.$op.$op2."=".$res) == ($tout1."-".$valdiff."=".$res))))
			   {
				 ...
				 $etape2 = true ;$etape_2=true;$verrou2=true;$finc=$k;
					 ...
					 (
						 ...
						 ||
						 (($op1.$op.$op2."=".$res) == ($op1."-".$valdiff."=".$res))
					 )
					 and 
					 (!$difference)
					 )
			   ...
			   {
				 $colonne6=2;$colonne7=1;
				 $operande1 = $op1; $operande2 = $op2; $resultatc = $res;
				 $resultat_comp = calcul($operande1,$op,$operande2);
				 $etape2 = true ;$etape_2=true;$verrou2=true;$finc=$k;$k++;
			   }
...
{/* debut else implicite */
		...
		else if((!$etape)and(!$etape_2)and((($op1==$tabImp[0])||($op2==$tabImp[0]))and(($op1==$tabImp[1])||($op2==$tabImp[1]))))
		{
		...
		else if (($question=='t')and((!$etape)and($etape_2))and(($op1.$op.$op2."=".$res)==($partie2."+".$resultatc."=".$res)||($op1.$op.$op2."=".$res)==($resultatc."+".$partie2."=".$res)))
		   {
		     ...
		     $resultat = $partie2;
								...
								/*-----------------------------------------------------------*/
											//=========colonne 14 et 15=============
	 if (($question=='p')and(($op1.$op.$op2."=".$res)==($resultat."+".$op2."=".$resultatc)))
		   {
	  ...
	  else if (($question=='t')and(!$imp3)and(($op1.$op.$op2."=".$res) == ($partie1."-".$valdiff."=".$res)))
			{
			 if (count($tabOperation)==$finc+1)
			 {
			 $colonne6 = 9; $colonne7 = 9;$colonne8=9; $arretc=true;
	...
	else if ((($op1.$op.$op2."=".$res) == ($resultat."-".$valdiff."=".$res))||(($op1.$op.$op2."=".$res) == ($resultat."+".$valdiff."=".$res)))
	 		{
			 $colonne14=4;
			 if($op=="-")
				 $colonne15 = 2;
   ...
   else if (($etape) and (count($tabOperation)==1) and (!isset($imp3))and($colonne2==1||$colonne2==2||$colonne2==3||$colonne2==7))
	{
		$colonne17=$colonne4;
		  if ($question=='t')
			$colonne14=1;
	...
	else if (($op1.$op.$op2."=".$res)and(!$difference) and (!$imp3) and (count($tabOperation)==1)and(count($T1)==1))
   		   {
			 $colonne14=5;
				 if ($op == '+')
					$colonne15=4;
  ...
  else if (($op1.$op.$op2."=".$res)and(!$difference) and (count($tabOperation)>1)and(count($T1)==1))
   		   {
			 $colonne14=5;
				 if ($colonne15==8)
				 	$colonne15=8;
 ...
 else if ((count($tabImp)!=0)and(count($tabOperation)==0)and(!ereg("$partie2|$partie3|$tout2",end($tabImp))) )
 		{
...
if (count ($T1) == 2 )
{
	...
	{
	 $colonne1=4; $colonne14=5; $colonne15 = 5; $colonne16=0;
...
else if(($colonne14=='5') and (ereg("[1-7]",$colonne2)) and (count($tabOperation)-1==2)) 
{
	$colonne14=51;
}
else if(($colonne14=='5') and (ereg("[1-7]",$colonne6)) and (count($tabOperation)-1==2)) 
{
	$colonne14=51;
}
...
if((!$etape)and($etape_2)and($etape3)and(($colonne14=='4' and $colonne1=='7')||(($colonne14=='5' ||$colonne14=='51')||(ereg("[5-8]",$colonne15)))))
{
	//print(" colonne1 = 7 ");
    $colonne1=7;
}
...
if (!isset($colonne1) || !(ereg("[0-7]",$colonne1))) $colonne1=9;
...
print("<br><br>colonne1 = ".$colonne1." colonne2 = ".$colonne2." colonne3 = ".$colonne3.
			 ...
			 " colonne8 = ".$colonne8." colonne10 = ".$colonne10." colonne11 = ".$colonne11.
			 " colonne12 = ".$colonne12." colonne14 = ".$colonne14." colonne15 = ".$colonne15.
			 " colonne16 = ".$colonne16." colonne17 = ".$colonne17." colonne18 = ".$colonne18);
exit ("ok");
$typeExo="a";
...
$Requete_SQL = "INSERT INTO trace (numEleve,numSerie,numExo,typeExo,questInt,sas ,choix,
				...
				'".$oper_1."','".$oper_2."','".$op_1."','".$op_2."','".$op_3."','".$text."','".$resultat."')";
