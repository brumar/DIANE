		...
		case 't':if (($tabImp[0]==$partie2 ) and (count($tabImp)==1))
				...
				else if (($tabImp[0]==$valdiff) and (count($tabImp)==1))
				 {
				  ...
				  $difference=true;$diff=true;
					...
					{
					//$resultatf=$tout2;
					$colonne1=5;$colonne14=0; $colonne15=0; $colonne16=9; $colonne17=0 ;
...
$Requete_SQL2 = "update diagnostic set 
						...
						colonne11=$colonne11, colonne12=$colonne12, colonne13=$colonne13, colonne14= $colonne14,colonne15=$colonne15,
...
//mysql_close();
unset($tabOperation,$tabOperation2,$text,$calcules,$tabCal,$i,$tabMot,$numeros,$tab,$num,$a,$nombre,$tabNombre,$Requete_SQL1);
unset($result,$val,$partie1,$partie2,$partie3,$tout1,$tout2,$valdiff,$question,$var,$dernierTabOp,$chaineOp,$chaineOper,$tabOperande,$tabImp);
unset($tabOperande0,$tabOperande1,$tabOperande2,$bool,$k,$etape,$etape1,$implicite,$etape2,$varImp,$typeExo,$resultat_compf,$resultatf,$res,$op,$op2,$op);
unset($operation1,$operande1,$operande2,$resultat_comp,$diff,$difference,$NonPertinent,$fine,$resultat,$resultatd,$resultat_compf,$op3,$operande3,$exclusion,$exclusion1);
unset($colonne1,$colonne2,$colonne3,$colonne4,$colonne5,$colonne6,$colonne7,$colonne8,$colonne9,$colonne10,$colonne11,$colonne12,
      $colonne13,$colonne14,$colonne15,$colonne16,$colonne17,$colonne18,$addTrou,$numTrace);
?>