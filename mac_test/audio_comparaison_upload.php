...
if((isset($_GET['delete']))){
	$ex=$_GET['num'];
	$dossier2 = "audio/comparaison/exo$ex/";//prendre les caracteristiques de l'enoncé 
		if (is_dir($dossier2)){
...
<?php
    ...
    header('Refresh: 2; url=audio_comparaison.php'); 
    ob_flush();	  
    } 
...
<!--
document.location.replace("audio_comparaison.php");
// -->
</script>';
...
<form method="POST" action="audio_comparaison_upload.php" enctype="multipart/form-data">
