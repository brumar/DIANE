<?php
session_start();
$num = $_SESSION["num"];//$_GET['num'];(int) trim($_POST[numero]);
...
<table width="780" align="center">
  <!--DWLayoutTable-->
  <tr> 
    <td width="359" rowspan="2" valign="top"> <table border="0" cellspacing="5">
        <tr> 
        ...
        <tr> 
          <td height="39"> <div align="center"> 
              <input type="button" value="Delete" name="efface5" style="font-size: 8pt" onclick="document.info.T1.value='';document.info.T1.focus();">
              <input type="text" name="T1" size="24" rows="1" cols="20" onFocus="monTour(5)" onSelect="this.value=''">
              <input name="button2" type="button" style="font-size: 8pt" onClick="inserer(document.info.T1.value+' ');" value="Type in the spaces provided">
            </div></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td align="center"> <input type="button" value=" 1 " name="un" onclick="afficher(1); "> 
          ...
          <td valign="top"> <table width="75%" border="0" cellspacing="0">
              ...
              <tr> 
                ...
                <td width="59"> <div id="efface"> 
                    <input type="button" value="Delete" name="efface1" style="font-size: 8pt" onclick="document.info.operande3.value='';document.info.operande3.focus();">
                  </div></td>
              </tr>
              <tr> 
              ...
              <tr> 
                ...
                <td>&nbsp;</td>
                <td> <input type="button" value="Delete" name="efface2" style="font-size: 8pt" onclick="document.info.operande1.value='';document.info.operande1.focus();"> 
                </td>
              </tr>
              <tr> 
                ...
                <td>&nbsp;</td>
                <td align="right"> <input type="button" name="operation" size="1" value="   " onClick="document.info.operande2.value='';document.info.operande2.focus();" > 
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr> 
                ...
                <td>&nbsp;</td>
                <td> <input type="button" value="Delete" name="efface3" style="font-size: 8pt" onclick="document.info.operande2.value='';document.info.operande2.focus();"> 
                </td>
              </tr>
              <tr> 
                <td><div align="right"> 
					...
					onClick="document.info.resultat1.value=''; document.info.operande1.value='';
							 ...
							 document.info.operande1.focus();" value="Delete the calculation">
                  </div></td>
                <td>&nbsp;</td>
              ...
              <tr> 
                ...
                <td>&nbsp;</td>
                <td> <input type="button" value="Delete" name="efface4" style="font-size: 8pt" onclick="document.info.resultat1.value='';document.info.resultat1.focus();"> 
                </td>
              </tr>
            </table></td>
        </tr>
        <tr> 
          <td height="30" align="center"> <input type="button" name="B2" value="Type in your calculation" onClick="verifCal();"></td>
        </tr>
      </table></td>
    <td width="34" rowspan="2" valign="top"></td>
    <td width="371" height="533" valign="top" align="center"> <h4>Type in your calculations and answers</h4>
      <input name="annuler" type="button" id="annuler" value="Cancel" style="font-size: 9pt" 
	  		onClick="if (zoneEcriture.isContentEditable==true) document.execCommand('Undo');" > 
      <input name="retour" type="button" style="font-size: 9pt" value="Start a new line" onClick="inserer('\n');"> 
      <input name="effacer" type="button" style="font-size: 9pt" id="effacer2" value="Delete everything"
	  	onClick="document.info.zonetexte.value='';document.info.zonetexte.focus();"> 
      <textarea id="zoneEcriture" contenteditable="true" name="zonetexte" cols="50" rows="28" wrap="hard" tabindex="1"
  ...
  <tr> 
    <td height="26" align="center" valign="top"> <input name="button" type="button" value="                 Exercise finished                " onClick="verifForm(); " tabindex="2"> 
    </td>
  </tr>
</table>
...
<div align="center"><a href="javascript:;" onClick="window.close();">Give up</a></div>
