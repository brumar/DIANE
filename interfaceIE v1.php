...
?>                    </td>
        ...
        <tr>
	     ...
	     <tr>
	       ...
	       <table width="100%"  border="0">
             <tr>
               <td width="33%" align="center"><input name="efface5" type="button" class="bouton"  onClick="document.info.T1.value='';document.info.T1.focus();" value="Effacer tout" style="width:110"></td>
		   ...
		   ></td>
			   ...
			   <input type="button" class="bouton" name="annuler2" value="Annuler" onClick="annulerSas();" style="width:70"></td>
             </tr>
           </table></td> 
        </tr>
        <tr>
	    ...
	    <tr>
        <td colspan="2" align="center" class="aide">Tu peux faire tes calculs ici	    </tr>
        ...
        <tr>
		  ...
		  onClick="verifCal(); 
				   ...
				   style="width:200"></td>
              <td align="left">
			  <input name="annuler3" type="button" class="bouton" id="annuler3" onClick="annulerOper();" value="Annuler" style="width:70">			  </td>
            </tr>
          </table></td>
        </tr>
        </table></td>
