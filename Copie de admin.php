...
<table width="43%" height="232" border="1" align="center" cellspacing="5">
  <tr> 
    <td bordercolor="#0000FF" bgcolor="#99FF99">
		<a href="affEnonce.php">Cr&eacute;er une s&eacute;rie d'exercices</a><a href="affichage_e.php"></a>
	</td>
  </tr>
  <tr> 
    <td height="24" bordercolor="#0000FF" bgcolor="#99FF99">
		<a href="supSerie.php">Supprimer une s&eacute;rie d'exercices</a><a href="affichage_e.php"></a>
	</td>
  </tr>
  <tr> 
    <td bordercolor="#0000FF" bgcolor="#99FF99">
		<a href="choixSerie.php">Choix des s&eacute;ries d'exercices</a> 
	</td>
  </tr>
  <tr> 
    <td bordercolor="#0000FF" bgcolor="#99FF99">
  ...
  <tr> 
    <td bordercolor="#0000FF" bgcolor="#99FF99">
		<a href="formTrace.html">Visualiser la page d'un &eacute;nonc&eacute; d'un &eacute;l&egrave;ve</a>
	</td>
  </tr>
  <tr> 
    <td bordercolor="#0000FF" bgcolor="#99FF99">
