		...
		<?php include("headerEnseignant.php"); ?>
			...
			<h1><a>Untitled Form</a></h1>
				...
				<p>
					...
					Attention, les élèves n'ont pas de mot de passe. Pour rentrer sur le site, leur date de naissance leur est demandée, faites donc bien attention à bien rentrer ces dates de naissance. Il y a toujours un risque de se faire passer pour un autre élève sans mot de passe individuel, gardez cela à l'esprit.
				</p>
				...
				<form action="createClass.php" display="none" method="post" class="appnitro" id="formulaire_creation_classe" onsubmit ="return verifClassForm();">
					<ul>
						...
						<li id="li_994">
							...
							<textarea id="f_eleves" name="eleves" rows="20" cols="50" placeholder="prénom_élève_1;nom_élève_1;date_naissance_élève_1"><?php if(isset($_SESSION['class_form'])){echo $_SESSION['class_form']['eleves']."\"";}?></textarea>
