<?php
 ...
 if(!isset($bool)||!$bool)
 {
	...
	$sql1 = "select count(*) as qte from trace where numEleve=".$numEleve;
	//$sql1 = "select count(*) as qte from trace where numExo = 40 and typeExo = 'a' and id >1409";
	$p = mysql_query($sql1);
	...
	$Requete_SQL1 = "SELECT id FROM trace where numEleve=".$numEleve;
	//	$Requete_SQL1 = "SELECT id FROM trace where numExo = 40 and typeExo = 'a' and id >1409";
